...
import { BACKEND_URL, ENVIRONMENT } from "@/config"
...
function LoginForm({
  ...
  ...props
    ...
    useEffect(function(){
      let env = ENVIRONMENT;
      let url = "http://localhost:3002/api/v1/admin/login/google"
      if(env == "production") {
          url =  "https://backend.quikcrats.com:3002/api/v1/admin/login/google"
      }
      setOauth(url)
    },[])
          ...
          <form >
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button variant="outline" className="w-full" onClick={function() {
